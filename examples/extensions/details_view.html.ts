...
export function getHtml(this: FakeElement & {
    a11yAssociation(name: string): string,
    getBackButtonAriaLabel_(): string,
    onCloseButtonClick_(): void,
    getBackButtonAriaRoleDescription_(): string,
    showAccountUploadButton_(): boolean,
    showDevReloadButton_(): boolean,
    onUploadClick_(): void,
    onReloadClick_(): void,
    showSafetyCheck_: boolean,
    onKeepClick_(): void,
    onRemoveClick_(): void,
    shouldShowMv2DeprecationMessage_(): boolean,
    getMv2DeprecationMessageIcon_(): string,
    getMv2DeprecationMessageHeader_(): string,
    getMv2DeprecationMessageSubtitle_(): string
    onFindAlternativeButtonClick_(): void,
    shouldShowMv2DeprecationFindAlternativeButton_(): boolean,
    onRemoveButtonClick_(): void,
    shouldShowMv2DeprecationRemoveButton_(): boolean,
    onActionMenuButtonClick_(): void
    getActionMenuButtonLabel_(): string,
    shouldShowMv2DeprecationActionMenu_(): boolean
    shouldShowMv2DeprecationFindAlternativeAction_(): boolean
    onFindAlternativeActionClick_(): void
    shouldShowMv2DeprecationKeepAction_(): boolean
    onKeepActionClick_(): void
    computeEnabledStyle_(): string
    computeEnabledText_(): string
    showReloadButton_(): boolean
} & any) {
